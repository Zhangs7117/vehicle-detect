...
This contains the true locations of the objects (cars) in the first 
	set of test images. 
The locations have been determined manually and are
	represented by the coordinates of the top-left corner of the best
	100x40 window containing each car. 
The nth row in the file
	corresponds to the nth test image; 
for example, if the nth test
